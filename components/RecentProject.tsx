  ...
  return (
    <div className="py-20">
     <h1 className="heading">
        ...
        justify-center p-4 gap-x-24 gap-y-8 mt-18">
              {projects.map(({id, title, des, img, iconLists, link}) =>(
                    <div key={id} className="sm:h-[32rem] h-[22rem] lg:min-h-[32,5rem]
                    flex items-center justify-center sm:w-96 w-[80vw]">
                    <PinContainer title={title} href={link}>
                           <div className="relative flex itme-center
                           justify-cnter sm:w-[400px] w-[80vw] overflow-hidden
